...
// Starsky 
    // Credit http://codepen.io/frexuz/pen/BvHsk
    var defaultClr = "#252525", //"#252525",
        mainClr = defaultClr,
        starClr = "rgb(255, 221, 157)";//"rgb(255, 221, 157)";
...
function start() {
    ...
    //Canvas and settings
    var canvas = document.getElementById("starsky"),
        ...
        shootingStars = [],
        layers = [
            { speed: 0.015, scale: 0.2, count: 320 }, //1000
